...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(txtaadhar, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGap(20, 20, 20)
                            .addComponent(jLabel5)
                            .addGap(18, 18, 18)
                            .addComponent(combodesignation, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, 530, -1));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if (combodesignation.getSelectedIndex() == 0) {
            ...
            try {
                ...
                String subject = "Welcome to Coding With Rehan!";
                String message = "Dear " + txtname.getText() + ",\n\n"
                        + "We are excited to welcome you to Coding With Rehan! Your account has been successfully created.\n\n"
                        + "Here are your account details:\n"
                        + "- Username: " + txtemail.getText() + "\n"
                        + "- Password: " + password + "\n\n"
                        + "Please keep your login credentials secure. If you have any questions or need assistance, feel free to reach out to our support team at rehanshaikh17775@gmail.com. \n\n"
                        + "Thank you for choosing Coding With Rehan! We look forward to serving you.\n\n"
                        + "Best regards,\n"
                        + "The Coding With Rehan Team\n";
